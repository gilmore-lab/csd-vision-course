...
```{r, out.width="500px", fig.cap="[(Adelson & Bergen, 1991)](http://citeseer.ist.psu.edu/viewdoc/summary?doi=10.1.1.2.9848)"}
knitr::include_graphics("img/plenoptic-function-adelson-1991.jpg")
```

---

```{r, fig.cap="[[@Chan2014-il]](https://doi.org/10.1007/978-0-387-31439-6_7)"}
knitr::include_graphics("https://media.springernature.com/original/springer-static/image/prt%3A978-0-387-31439-6%2F15/MediaObjects/978-0-387-31439-6_15_Part_Fig1-7_HTML.gif")
```
...
```{r, fig.cap="Source: Wikipedia", out.width="900px"}
knitr::include_graphics("https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/EM_Spectrum_Properties_edit.svg/1200px-EM_Spectrum_Properties_edit.svg.png")
```
...
<div class="centered">
Light is refracted (bent) by some substances
...
```{r, out.width="900px"}
knitr::include_graphics("https://thebrain.mcgill.ca/flash/a/a_02/a_02_p/a_02_p_vis/a_02_p_vis_1p.jpg")
```

---

```{r, out.width = "900px"}
knitr::include_graphics("https://thebrain.mcgill.ca/flash/a/a_02/a_02_p/a_02_p_vis/a_02_p_vis_1q.jpg")
```
...
```{r, out.width="600px"}
knitr::include_graphics("https://hmslade5.files.wordpress.com/2012/03/anatomy-of-the-eye.jpg")
```

## as an auto-focus, auto-exposure camera...

```{r}
knitr::include_graphics("https://www.optilase.com/wp-content/uploads/2014/12/camera-lens-eye-lens.jpg")
```
